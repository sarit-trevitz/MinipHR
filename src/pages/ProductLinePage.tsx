...
//   const { product_lines: productLinesList, product, createRecord, updateRecord, deleteRecord } = useHR();
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [editingLine, setEditingLine] = useState<ProductLineType | null>(null);
  
//   // סטייט חדש לחיפוש לפי ID
...
//       {/* Grid rendering database production lines with scroll support */}
...
//                      <button onClick={() => deleteRecord('product_line', 'pl_id', line.pl_id)} className="p-2 text-brand-secondary hover:bg-brand-ink/5 rounded-lg"><Trash2 size={14}/></button>
//                    </div>
...
//       {/* Modal with internal scrollable body */}
//       <AnimatePresence>
//         {isModalOpen && (
