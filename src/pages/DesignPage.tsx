...
//   const { design: designList, product, createRecord, updateRecord, deleteRecord } = useHR();
...
//       {/* Grid עם גלילה פנימית להגנה על הממשק */}
...
//           return (
//             <motion.div key={designItem.d_id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-[2rem] border border-brand-ink/5 shadow-sm overflow-hidden flex flex-col justify-between">
//               <div className="h-24 bg-brand-secondary/10 relative overflow-hidden flex items-center justify-center">
//                 <ClipboardList size={36} className="text-brand-secondary opacity-20" />
...
//                 </div>
//               </div>
//               <div className="p-4 border-t border-brand-ink/5 flex gap-2">
//                 <button onClick={() => handleOpenEdit(designItem)} className="flex-1 p-2 bg-brand-ink/5 rounded-lg text-brand-primary"><Edit2 size={14}/></button>
//                 <button onClick={() => deleteRecord('design', 'd_id', designItem.d_id)} className="flex-1 p-2 bg-brand-ink/5 rounded-lg text-brand-secondary"><Trash2 size={14}/></button>
//               </div>
//             </motion.div>
//           );
//         })}
...
//       {/* Modal עם גלילה פנימית לתוכן הטופס */}
//       <AnimatePresence>
//         {isModalOpen && (
        ...
        {filteredDesign.map((designItem) => {
          ...
          return (
            <motion.div key={designItem.d_id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-[2rem] border border-brand-ink/5 shadow-sm overflow-hidden flex flex-col justify-between">
              ...
              <div className="p-4 border-t border-brand-ink/5 flex gap-2">
                <button onClick={() => handleOpenEdit(designItem)} className="flex-1 p-2 bg-brand-ink/5 rounded-lg text-brand-primary"><Edit2 size={14}/></button>
                <button onClick={() => handleDeleteClick(designItem)} className="flex-1 p-2 bg-brand-ink/5 rounded-lg text-brand-secondary"><Trash2 size={14}/></button>
              </div>
            </motion.div>
          );
        })}
