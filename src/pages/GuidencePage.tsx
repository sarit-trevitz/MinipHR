...
//   // סטייט חדש עבור שורת החיפוש המשולבת (GID או שם מרצה) 🔍
...
//   // מנגנון סינון דינמי המשלב חיפוש לפי GID אבסולוטי או שם המרצה המשובץ 🧠
...
//         {/* שורת חיפוש משולבת חכמה הממוקמת בראש העמוד */}
...
//                   </button>
//                   <button 
//                     onClick={() => deleteRecord('guidence', 'gid', currentGid)}
...
//                 {/* Left Badge Branding Information Layout */}
...
//                 {/* Right Data Grid Properties Info Container */}
...
//       {/* Add/Edit Interactive Overlay Modal Form */}
//       <AnimatePresence>
//         {isModalOpen && (
...
//       {/* Relational Inspection Drawer Dialogue - תיקון: הסרת תיבת ה-Metadata הלבנה ופירוט נקי */}
//       <AnimatePresence>
...
//                 <div>
//                   {/* תיקון: הצגת שם המרצה ישירות בכותרת במקום ה-ID החשוף */}
//                   <h3 className="text-2xl font-black tracking-tighter italic serif">
...
//               {/* רשימת המשובצים הרילציונית הנקייה (הסרת הריבוע הלבן הישן) */}
